...
2. Database name: `medigo_db`
3. Collation: `utf8mb4_general_ci`
4. Click **Create**

## Step 3: Run SQL Schema

1. Select the `medigo_db` database
2. Click the **SQL** tab
...
2. Check phpMyAdmin → `medigo_db` → `users` table
...
- Verify database name is `medigo_db`
- Check if port 3306 is available
- Verify credentials in `.env`

**Table doesn't exist?**
- Run the SQL schema again in phpMyAdmin
- Make sure you selected the `medigo_db` database first
